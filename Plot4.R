...
with(elec_consumtion , plot(dates, Global_active_power, type="l", 
                            ...
                            main=""))
#graph2
with(elec_consumtion, plot(dates, Voltage, type="l", xlab="datetime", ylab="Voltage", main =""))
#graph3
with(elec_consumtion, plot(dates, Sub_metering_1, type="n", xlab="", ylab="Energy sub metering"))
points(elec_consumtion$dates, elec_consumtion$Sub_metering_1, col="black", type = "l")
points(elec_consumtion$dates, elec_consumtion$Sub_metering_2, col="red", type = "l")
points(elec_consumtion$dates, elec_consumtion$Sub_metering_3, col="blue", type = "l")
legend("topright", pch = "_", col = c("black", "red", "blue"), 
       legend = c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"))
#graph4
with(elec_consumtion, plot(dates, Global_reactive_power, type="l", main ="", xlab="datetime", ylab = "Global_reactive_power"))
